        ...
        <div className="md:mt-20 mt-[65px] flex flex-col">
            ...
            <div className="flex flex-col justify-center items-center px-12 mt-10 mb-12 iten">
                ...
                <div className='flex flex-col md:flex-row gap-2 my-10'>
                    ...
                    <div className='cursor-pointer rounded-lg text-dark-color flex-row flex gap-2 py-4 px-2'
                        onClick={
                            () => {
                    ...
                    >
                        <div className='bg-primary-color fill-primary-color rounded-full h-[36px] w-[36px] flex-row flex items-center justify-center'>
                    ...
                    <div className='rounded-lg text-dark-color flex-row flex gap-2 py-4 px-2'
                        style={{
                            boxShadow: '0px 1px 2px rgba(7, 32, 51, 0.4), 0px 2px 6px 2px rgba(7, 32, 51, 0.2)'
                        }}
                    >

    ...
    return (
        <div className='md:mt-20 mt-[65px] flex flex-col'>
            ...
            <div className='flex flex-col md:flex-row  items-center justify-center md:gap-10'>
                ...
                <div>
                    <h1 className='my-5 px-12 text-3xl md:mt-16 md:text-4xl md:4xl font-semibold'>
                        <span className='text-dark-teal'>Interview </span>  Preparation Kit
                    </h1>
                    <div className='flex flex-col gap-4 px-12 my-2 items-center mb-10'>
                        <svg width="310" height="380" viewBox="0 0 310 380" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="310" height="380" rx="12" fill="#C5EEF0" />

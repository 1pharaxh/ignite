...
export default function JobCard({ title, duration, roles, requirements }) {
    return (
        <div className="bg-teal-600 rounded-lg md:p-10 px-2 py-4 w-[440px] md:w-[550px] h-auto flex flex-col md:gap-4 gap-3 items-center justify-center">
            ...
            <div className="row row-col gap-2 md:pl-5 pl-2">
                {roles.map((role, index) => {
                    return (
                        <div className="flex flex-row md:gap-4 gap-2" key={index}>

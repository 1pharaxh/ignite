            ...
            <div className="md:hidden flex flex-col gap-4 mx-12">
                ...
                <div className="flex flex-row gap-4 items-center justify-center">
                    ...
                    <motion.div
                        ...
                        className="bg-teal-700 rounded-lg shadow-lg basis-1/2 h-24 flex flex-col gap-2 items-center justify-center">
                        <h1 className="text-2xl text-white font-semibold">{colleges}</h1>
                ...
                <motion.div
                    ...
                    animate={inView ? "visible" : "hidden"}
                    variants={rightVariants}
                    className="bg-teal-700 rounded-lg shadow-lg flex flex-col gap-2 items-center justify-center h-24">
